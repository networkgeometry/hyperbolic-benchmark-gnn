...
{
    /**
     * ./main [Beta_s] [gamma_s] [Ns_obs] [kmean_s] [gamma_n] [kmean_n] [gamma_f] [N_f] [Beta_bi] [nu] [outfolder]
     * 
     * S1 model parameters:
     * 
     ...
     */
    if (argc != 12) {
        printf("Please provide all 11 parameters\n");
        exit(0);
    }
