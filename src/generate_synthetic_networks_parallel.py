...
@background
def generate_networks(ntimes, Beta_s_val, gamma_s_val, Ns_obs_val, kmean_s_val, gamma_n_val, kmean_n_val, gamma_f_val, N_f_val, Beta_bi_val, nu_val, alpha_val, N_labels_val):
...
if __name__ == '__main__':
    ...
    looper = asyncio.gather(*[
        generate_networks(ntimes, Beta_s_val, gamma_s_val, Ns_obs_val, kmean_s_val, gamma_n_val, kmean_n_val, gamma_f_val, N_f_val, Beta_bi_val, nu_val, alpha_val, N_labels_val) 
